...
"""
Mailroom Exercise -- no dictionaries or Exceptions
"""
...
# loop through the donor list and print the names
def print_donors():
    print("Donor list:\n")
...
def send_thank_you():
    ...
    # If this is a new user, ensure that the database has
    ...
    # Record the donation
    # Note how the donor object can be manipulated while
    #      it is in the donors list.
    donor[1].append(amount)

    print(gen_letter(donor))


# you could also use operator.itemgetter(1) here.
def sort_key(item):
    return item[1]

...
def test_render_element():
    ...
    assert file_contents.startswith("<placeholder>")
    assert file_contents.endswith("</placeholder>")

    assert file_contents.count("<placeholder>") == 1
    assert file_contents.count("</placeholder>") == 1

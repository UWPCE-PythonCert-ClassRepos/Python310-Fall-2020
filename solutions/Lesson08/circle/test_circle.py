...
def test_init():
    """
    just making sure you can initilize one

    not very useful test -- but it's good for getting started with TDD
    """
    c = Circle(3)
...
def test_init_empty():
    """
    should raise an exception if no radius is passed in
    """
